...
class FirebaseAuthMethods {
  ...
  Future<void> signUpWithEmail({
    ...
    try {
      ...
      await saveFirestoreProfile(context, name, imageUrl, email);
  ...
  Future<void> saveFirestoreProfile(BuildContext context, String name, List<XFile>? imageUrl, String email) async {
    final userAuth = FirebaseAuth.instance.currentUser;
    final userID = userAuth?.uid;
    final DocumentSnapshot doc = await usersRef.doc(userAuth?.uid).get();
    String? imageurl;
